...
public class Templates {
    ...
    static {
        ...
        groupStyle = stl.style(boldStyle).setHorizontalTextAlignment(HorizontalTextAlignment.CENTER);
        ...
        HyperLinkBuilder link = hyperLink("https://www.extremenetworks.com/");
        dynamicReportsComponent = cmp.horizontalList(cmp.image(Templates.class.getResource("images/dynamicreports.png")).setFixedDimension(60, 60),
                cmp.verticalList(cmp.text("Extreme Networks").setStyle(bold22CenteredStyle).setHorizontalTextAlignment(HorizontalTextAlignment.LEFT),
                        cmp.text("http://www.extremenetworks.com").setStyle(italicStyle).setHyperLink(link))).setFixedWidth(300);
    ...
    public static ComponentBuilder<?, ?> createTitleComponent(String label) {
        return cmp.horizontalList()
                .add(dynamicReportsComponent, cmp.text(label).setStyle(bold18CenteredStyle).setHorizontalTextAlignment(HorizontalTextAlignment.CENTER))
                .newRow()
                .add(cmp.line())
                .newRow()
